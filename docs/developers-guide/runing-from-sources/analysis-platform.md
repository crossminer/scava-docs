...
![Eclipse Preferences](images/eclipse_preferences_1.png | width="200" height="200")<br />
Figure 1. Eclipse Preferences.

1. Add a new Target Platform for the project, choose the Default initialization.
![Eclipse Target Platform](images/eclipse_target_platform_2.png | width="200" height="200")<br />
...
![Eclipse Target Platform](images/eclipse_target_platform_3.png | width="200" height="200")<br />
Figure 3. Eclipse Target Platforms.

1. Finally, check the new target Configuration, then save the changes.
![Eclipse Target Platform](images/eclipse_target_platform_4.png | width="200" height="200")<br />
